...
let numEvenOrOdd:number; // Determine if this is even or odd.
numEvenOrOdd=11;
...
let fahrenheit:number; // Convert this to Celsius and print the result.
fahrenheit = 98.6;
...
let number:number; // Determine the sign of this number.
number=-7;
if(number>0){
